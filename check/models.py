...
class Checklist(models.Model):
    ...
    """
    list_name = models.CharField(max_length=75, blank=False, unique=False, help_text="(Max 75 characters)")
    ...
    class Meta:
        ordering = ["-created_on"]
        constraints = [
            models.UniqueConstraint(fields=['user', 'list_name'], name='unique_user_list_name')
        ]
